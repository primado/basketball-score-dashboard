...
// const WS_URL = 'ws://192.168.1.100:8081'
...
export default function Dashboard() {
    ...
    useEffect(() => {
      const intervalId = setInterval(() => {
        fetch('http://192.168.1.100:5000/cont_data/')
          .then((res) => res.json())
   ...
   d = data;
    ...
    useEffect(() => {
      ...
      if (isActive && seconds > 0) {
        ...
        fetch('http://192.168.1.100:5000/score', {
          method: 'POST',
          headers: {
        ...
        <div>
            <section className="bg-home-bg bg-no-repeat bg-center bg-cover min-h-screen w-full sm-412:h-screen sm-412:w-screen sm-412:px-12 sm-412:py-20 sm-428:px-12 sm-428:py-20 sm-428:w-screen sm-428:h-screen md-810:h-screen md-768:w-screen md-768:h-screen md-900:w-screen md-900:h-screen">
                <div className="main-container">
                    <h1 className="text-[#fff] text-3xl text-center font-roboto font-extrabold mb-12 sm-375:mb-8 sm-425:text-base 2xl-1440:text-5xl 3xl-2560:text-5xl">Dashboard
                      ...
                      <div className="score-container">
                            <div className="score">
                                ...
                                >
                                    ...
                                    <p className="font-semibold text-xl text-white">{"data.player_name1"}</p>
                        <div className="clock">
