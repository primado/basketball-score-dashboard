...
export default function Dashboard() {
    ...
    return (
        <div>
            <section className="bg-bg_dark_grey py-24 w-full h-full sm-412:h-screen sm-412:w-screen sm-412:px-12 sm-412:py-20 sm-428:px-12 sm-428:py-20 sm-428:w-screen sm-428:h-screen md-810:h-screen md-768:w-screen md-768:h-screen md-900:w-screen md-900:h-screen">
